...
describe("layerStack", () => {
  ...
  it("returns an empty stack for a namespace without layers", () => {
...
describe("canvas geometry", () => {
  ...
  it("namespaces world rectangles into screen space", () => {
    expect(
      worldRectToScreenRect(
...
describe("warpInDirection", () => {
  ...
  it("returns null only when the namespace has no warps", () => {
