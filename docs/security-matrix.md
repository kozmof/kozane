...
costs no more to read than a workspace of a few — and by a ceiling on how many
tags one taskspace may yield, since a file can hold far more tags per byte read
